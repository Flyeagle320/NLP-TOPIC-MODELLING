# -*- coding: utf-8 -*-
"""
Created on Wed Sep  7 06:59:29 2022
...
import pandas as pd
my_tweet = pd.read_csv('D:\\DATA SCIENCE ASSIGNMENT\\NLP-TM\\Data.csv' , usecols=['text'])#loading dataset
...
def calculate_coherence_score(documents, dictionary, model):
    coherence_model = CoherenceModel(model=model, texts=documents, dictionary=dictionary, coherence='u_mass')
...
# data loading 
import pandas as pd
my_tweet = pd.read_csv('D:\\DATA SCIENCE ASSIGNMENT\\NLP-TM\\Data.csv' , usecols=['text'])

#running LSA model for data
documents, dictionary, model = run_lsa_process(my_tweet['text'], number_of_topics=5)

##printing 5 LSA model topic #
model.print_topics
...
import pandas as pd
my_tweet = pd.read_csv("C:/Users/hp/Desktop/NLP assi/Data.csv",usecols=['text'])
...
article = open('D:/DATA SCIENCE ASSIGNMENT/NLP-TM/NLP-TM.txt' ,encoding='utf8')
